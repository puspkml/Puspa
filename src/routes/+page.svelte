...
<svelte:head>
  ...
  <meta name="description" content="I'm a Flutemoligist, who loves programming and developing web applications. Driven by a deep passion for Physics, I combine it with programming to turn my ideas and imagination into reality." />
</svelte:head>
