...
<footer class="relative bg-gradient-to-br from-zinc-900 via-slate-600 to-slate-900 text-white">
	...
	<div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
		<div class="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
			<!-- About Section -->
			<div class="space-y-4">
				<h3 class="font-serif text-2xl font-bold bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
					Puspa Kamal Rai
				</h3>
				<p class="text-sm text-gray-300 leading-relaxed">
					Physicist, Developer & Musician. Passionate about semiconductors, optics, embedded systems, and web development.
				</p>
			</div>

			<!-- Quick Links -->
			<div class="space-y-4">
				<h4 class="font-semibold text-lg text-blue-300">Quick Links</h4>
				<ul class="space-y-2">
			...
			<!-- Social Links -->
			<div class="space-y-4">
				<h4 class="font-semibold text-lg text-blue-300">Connect</h4>
				<div class="flex flex-wrap gap-4">
					{#each socialLinks as social}
						<a
							...
							class="group flex items-center justify-center w-12 h-12 rounded-full bg-white/10 backdrop-blur-sm transition-all duration-300 hover:bg-white/20 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/50"
				...
				<p class="text-xs text-gray-400 mt-4">
					Feel free to reach out for collaborations, research opportunities, or just to chat!
				</p>
			</div>
		</div>
