...
export const content: ContentItem[] = [
	...
	// Blogs
	{
		...
		description:
			"Even if I try to play softly, it still somehow cuts through the entire band. People have literally turned around mid-rehearsal to give me 'the look'...",
		link: '/blogs/piccolo',
	...
	},
	{
		...
		description:
			' Me, the ever-curious troublemaker, raised my hand. Sir, in which force does the materialization of God — like vibhooti or honey appearing — fit? The whole class froze. And the teacher, clearly not ready for this level of chaos on Day 1...',
